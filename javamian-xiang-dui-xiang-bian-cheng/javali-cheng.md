...
import com.supermarket.market.LittleSuperMarket;
import com.supermarket.market.Merchandise;
import com.supermarket.person.Customer;
    ...
    public static void main(String[] args) {
        ...
        while (open) {
            ...
            while (true) {
                ...
                if (numToBuy <= 0) {
                    System.out.println("不买看看也好,欢迎继续挑选商品.");
                    continue;
                }

                if (numToBuy > m.count) {
                    System.out.println("本店此商品库存没有那么多,欢迎继续选购商品.");
                    continue;
                }

                if (numToBuy * m.purchasePrice + totalCost> customer.money) {
                    System.out.println("您带的钱不够,欢迎继续挑选商品.");
                    continue;
                }
